...
function toggleHeadlines() {
	...
	}, '-=0.375').set('#headline-swap .swap-container-1', { css: { y: 40, opacity: 0 } });
	...
	}, '-=0.375').set('#headline-swap .swap-container-2', { css: { y: 40, opacity: 0 } });
}
...
function initAnimations() {
	...
	helicopterTimeline.fromTo('.illustration__helicopter', 4, { x: 165, y: 164 }, { x: 167, y: 211 }).to('.illustration__helicopter', 4, { x: 141, y: 216 }).to('.illustration__helicopter', 4, { x: 151, y: 170 }).to('.illustration__helicopter', 4, { x: 165, y: 164 });
	...
	shipTimeline.set('.illustration__game-lasers', {
		x: function x(i) {
			return '-=' + i * 9;
		}
	}).set('.illustration__game-ship', { rotate: 80 }).set('.illustration__game-meteor-sm[data-num="2"]', { x: 16, y: 60, rotation: 0 }).to('.illustration__game-ship', 2, { rotation: '-=80', ease: Power2.easeInOut }).to('.illustration__game-ship', 2, { rotation: '+=172', ease: Power2.easeInOut }).staggerTo(['.illustration__game-lasers[data-num="1"]', '.illustration__game-lasers[data-num="2"]', '.illustration__game-lasers[data-num="3"]'], 1.2, { x: 49, y: 3, ease: Power0.easeNone }, 0.25).fromTo('.illustration__game-meteor-sm[data-num="2"]', 3, { x: 107, y: -50, rotation: 0 }, { x: 54, y: 3, rotation: -110, ease: Power0.easeNone }, '-=4.2').staggerTo(['.illustration__game-lasers[data-num="1"]', '.illustration__game-lasers[data-num="2"]', '.illustration__game-lasers[data-num="3"]'], .2, { opacity: 0, ease: Power0.easeNone, delay: 0.5 }, 0.1, '-=1.35')
	// .fromTo('.illustration__game-meteor-sm[data-num="2"]', 3, {x: 11, y:-114, rotation: 0}, {x: 9, y:0, rotation: -110, ease:Power0.easeNone}, '-=5')
	.fromTo('.illustration__game-explosion', 0.3, { opacity: 0 }, { opacity: 100, ease: Power0.easeNone }, '-=1').to('.illustration__game-meteor-sm[data-num="2"]', 0.01, { opacity: 0 }, '-=1').set('.illustration__game-explosion', { opacity: 0 }).to('.illustration__game-ship', 2, { rotation: '-=92', ease: Power2.easeInOut });
	...
	helicopter3Timeline.fromTo('.section__illustration__helicopter[data-num="2"]', 6, { x: 316, y: -40 }, { x: 361, y: -19 }).to('.section__illustration__helicopter[data-num="2"]', 6, { x: 331, y: -2 }).to('.section__illustration__helicopter[data-num="2"]', 6, { x: 285, y: -6 }).to('.section__illustration__helicopter[data-num="2"]', 6, { x: 316, y: -40 });
	...
	eyesTimeline.to('.section__illustration__connect-eyes', 0.08, { scaleY: 1 }).to('.section__illustration__connect-eyes', 0.2, { scaleY: 0.1 }, '+=2').to('.section__illustration__connect-eyes', 0.1, { scaleY: 1 });
	...
	helicopter2Timeline.to('.section__illustration__helicopter[data-num="1"]', 4, { x: '+=2', y: '+=20' }).to('.section__illustration__helicopter[data-num="1"]', 4, { x: '+=10', y: '+=10' }).to('.section__illustration__helicopter[data-num="1"]', 4, { x: '-=18', y: '-=15' }).to('.section__illustration__helicopter[data-num="1"]', 4, { x: '+=6', y: '-=15' });

	//robot helicopter
	var helicopter3Timeline = new TimelineMax({ repeat: -1, yoyo: true, ease: Sine.easeInOut });
	helicopter3Timeline.to('.section__illustration__robot #helicopter, .section__illustration__robot-helicopter-blades', 4, { x: '+=20', y: '+=40' }).to('.section__illustration__robot #helicopter, .section__illustration__robot-helicopter-blades', 6, { x: '+=10', y: '-=20' }).to('.section__illustration__robot #helicopter, .section__illustration__robot-helicopter-blades', 6, { x: '-=30', y: '-=20' });
